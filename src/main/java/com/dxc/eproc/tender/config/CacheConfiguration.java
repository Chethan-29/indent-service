...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.dxc.eproc.tender.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.dxc.eproc.tender.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.dxc.eproc.tender.domain.User.class.getName());
            createCache(cm, com.dxc.eproc.tender.domain.Authority.class.getName());
            createCache(cm, com.dxc.eproc.tender.domain.User.class.getName() + ".authorities");
